...
public class CheckOutPage extends Utility {
    ...
    public void enterLogindetailsAndClickOnLoginButton() {
        ...
        sendTextToElement(passwordLink, "zyx123");
    ...
    public void enterMandatoryDetails() {
        ...
        selectByVisibleTextFromDropDown(countrySelection, "United Kingdom");
        CustomListeners.test.log(Status.PASS, "Select Country");
        Reporter.log("Select State" + stateSelection.toString());
        selectByVisibleTextFromDropDown(stateSelection, "AA (Armed Forces London)");
    ...
    public void enterCardDetails() {
        ...
        selectByVisibleTextFromDropDown(month, "08");
